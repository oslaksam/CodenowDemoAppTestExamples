package io.testproject.generated.tests.demoemail;
 ...
 * Test: DemoAppTestWrongEmail
 * Generated by: Bou Rat (pizdik25@gmail.com)
 * Generated on Fri May 06 10:07:02 GMT 2022.
 */
@DisplayName("DemoAppTestWrongEmail")
public class Demoapptestwrongemail implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String randomName, String randomLastName, String randomEmail,
    ...
    // 16. Type 'wrongEmailTestProject' in 'email'
    by = By.cssSelector("[name='email']");
    driver.findElement(by).sendKeys("wrongEmailTestProject");
    ...
    waitForAlertPresence = WebExtensions.waitForAlertPresence(1000);
