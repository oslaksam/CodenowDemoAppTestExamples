package io.testproject.generated.tests.demopost;
 ...
 * Generated on Fri May 06 10:07:51 GMT 2022.
 */
@DisplayName("DemoAppApiTest")
public class Demoappapitest implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String ApiPost, String name, String lastName, String email,
    ...
    // 4. POST '{{ApiPost}}'?'[NONE]'
    GeneratedUtils.sleep(500);
    postAction = RESTfulAPIClient.postAction(String.format("{
            ...
            \"seatId\": \"1-21\",
            \"trainId\": \"ICE-575\"
        }",email,name,lastName),"","",ApiPost,"","","200","",false,"",false,"","");
