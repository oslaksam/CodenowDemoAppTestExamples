package io.testproject.generated.tests.demopostfail;
 ...
 * Test: DemoAppApiTestFail
 * Generated by: Bou Rat (pizdik25@gmail.com)
 * Generated on Fri May 06 10:08:14 GMT 2022.
 */
@DisplayName("DemoAppApiTestFail")
public class Demoappapitestfail implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String ApiPost, String name, String lastName, String email,
    ...
    name = String.valueOf(generateName.result);

    // 2. Generate random last name
    GeneratedUtils.sleep(500);
    ...
    lastName = String.valueOf(generateLastName.result);

    // 3. Generate random email address
    GeneratedUtils.sleep(500);
    randomEmail = RandomLoginCredentials.randomEmail("","",15,true,true,true);
    randomEmail = (RandomLoginCredentials.RandomEmail)((ReportingDriver)driver).addons().execute(randomEmail);
    email = String.valueOf(randomEmail.emailAddress);

    // 4. POST '{{ApiPost}}'?'[NONE]'
    GeneratedUtils.sleep(500);
    postAction = RESTfulAPIClient.postAction("{\n\n}","","",ApiPost,"","","500","",false,"",false,"","");
    postAction = (RESTfulAPIClient.PostAction)((ReportingDriver)driver).addons().execute(postAction);
    response = String.valueOf(postAction.response);
  ...
  private static Stream provideParameters() throws Exception {
    return Stream.of(Arguments.of("https://demo-app-fe.vercel.app/","https://demo-app-spring-api-aca-demo.stxcn-aca.stxcn.codenow.com/reservation","","","",""));
  }
}
